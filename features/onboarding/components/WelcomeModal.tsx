        ...
        <div className="fixed inset-0 bg-background/90 backdrop-blur-lg z-[200] flex items-center justify-center p-4">
            <div className="w-full max-w-2xl text-center">
                ...
                <p className="text-slate-400 mt-6 max-w-xl mx-auto">
                    You've been granted <strong className="text-amber-300">100 complimentary AI Credits</strong> just for signing up. Complete your first guided mission to earn a <strong className="text-amber-300">bonus of 25 credits!</strong> Let's start by setting up your profile.
                </p>
